...
function getPreviousSibling(ele) {
  ...
  if (firstEle == ele) return null; //向上找上一个元素节点
...
function getStyle(dom, attr) {
  return dom.currentStyle ? dom.currentStyle[attr] : getComputedStyle(dom)[attr]; //dom.currentStyle在IE8下返回一个对象，谷歌下返回undefined
} //阻止事件冒泡
